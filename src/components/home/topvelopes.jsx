...
const Topvelopes = () => {
	...
	return (
		<div className="flex justify-center">
			<div className="flex flex-col items-center py-2 md:py-6 border-b w-[95%] xl:w-[80%] 2xl:w-[1500px]">
				<div className="font-Heading pb-2 text-[.7em] md:text-base 2xl:text-2xl">
					Most Velopes today
				</div>

				<div className="md:hidden flex items-center justify-center relative w-[85%] h-[150px] overflow-hidden">
					<button
					...
					<div
						key={currentIndex}
						className={`relative w-36 mx-auto absolute transition-all duration-300 ${
							animating
								? direction === "right"
									? "slide-exit-right"
									: "slide-exit-left"
					...
					>
						...
						<p className="absolute inset-0 flex items-center justify-center text-sm text-black pointer-events-none font-Content font-Special font-bold">
