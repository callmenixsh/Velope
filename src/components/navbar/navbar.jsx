...
const navbar = () => {
	...
	return (
		<>
			...
			<h2 className="font-Heading text-[.5em] md:text-base 2xl:text-2xl md:mt-2 text-center flex flex-col items-center justify-end py-5 transition-all duration-300">
